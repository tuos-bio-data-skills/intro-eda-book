...
Just remember that all the ggplot code joined by `+` symbols has to be run as one---it all belongs together even if we decide to place the component parts on different lines.
